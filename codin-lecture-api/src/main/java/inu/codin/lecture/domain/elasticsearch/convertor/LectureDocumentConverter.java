package inu.codin.lecture.domain.elasticsearch.convertor;

import inu.codin.lecture.domain.elasticsearch.document.LectureDocument;
import inu.codin.lecture.domain.elasticsearch.document.dto.EmotionInfo;
import inu.codin.lecture.domain.elasticsearch.document.dto.ScheduleInfo;
import inu.codin.lecture.domain.elasticsearch.document.dto.SemesterInfo;
import inu.codin.lecture.domain.lecture.entity.Lecture;
import inu.codin.lecture.domain.lecture.entity.LectureSchedule;
import inu.codin.lecture.domain.lecture.entity.LectureSemester;
import inu.codin.lecture.domain.lecture.entity.LectureTag;
