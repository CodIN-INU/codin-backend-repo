package inu.codin.lecture.domain.elasticsearch.service;

import inu.codin.lecture.domain.elasticsearch.convertor.LectureDocumentConverter;
import inu.codin.lecture.domain.elasticsearch.document.LectureDocument;
import inu.codin.lecture.domain.elasticsearch.event.LectureDeletedEvent;
import inu.codin.lecture.domain.elasticsearch.event.LectureSavedEvent;
import inu.codin.lecture.domain.elasticsearch.repository.LectureElasticRepository;
