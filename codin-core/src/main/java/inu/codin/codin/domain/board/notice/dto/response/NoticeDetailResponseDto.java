...
public class NoticeDetailResponseDto {
    ...
    public NoticeDetailResponseDto(String userId, String _id, String title, String content, String nickname , PostCategory postCategory, String userImageUrl, List < String > postImageUrls,
                                   boolean isAnonymous, int scrapCount, int hits, LocalDateTime createdAt, UserInfo userInfo){
        this.userId = userId;
        this._id = _id;
        this.title = title;
    ...
    public static class UserInfo {
        ...
        @Builder
        public UserInfo(boolean isScrap, boolean isMine) {
            this.isScrap = isScrap;
            this.isMine = isMine;
        }
    }

    public static NoticeDetailResponseDto of(PostEntity post, String nickname, String userImageUrl, int scrapCount, int hitsCount, UserInfo userInfo) {
