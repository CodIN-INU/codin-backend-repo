...
import inu.codin.auth.service.AuthCommonService;
import inu.codin.auth.service.AuthSessionService;
...
public class AuthController {
    ...
    public ResponseEntity<?> reissue(HttpServletRequest request, HttpServletResponse response) {
        jwtTokenIssuer.checkRefreshTokenAndReissue(request, response);
